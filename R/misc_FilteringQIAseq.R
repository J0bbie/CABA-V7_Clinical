...
vcfFiles <- list.files('/mnt/share1/hartwig/DR71/Misc/CABAV7', pattern = 'ann.tsv.gz', full.names = T)
...
cosmicSNPs <- readr::read_tsv('/mnt/share1/hartwig/DR71/Misc/cosmicSNPs.txt', col_names = 'ID', skip = 1)
